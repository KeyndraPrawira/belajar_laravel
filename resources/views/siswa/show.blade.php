        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$siswa->nis}}" id="nis" name="nis" disabled>
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama</label>
                        <input type="text" class="form-control" value="{{$siswa->nama}}" id="nama" name="nama" disabled>
                    </div>
                    <div class="form-group">
